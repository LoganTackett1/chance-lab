...
export default function SlotForm({ defaults, onSubmit, loading }: SlotFormProps) {
  ...
  const [smallWinChance, setSmallWinChance] = useState(
    defaults.smallWinChance ?? 0.15
  );
  const [bigWinChance, setBigWinChance] = useState(defaults.bigWinChance ?? 0.05);

  const [smallWinMultiplier, setSmallWinMultiplier] = useState(
    defaults.smallWinMultiplier ?? 2.0
  );
  const [bigWinMultiplier, setBigWinMultiplier] = useState(
    defaults.bigWinMultiplier ?? 10.0
  );
  ...
  return (
    <form id="slot-form" onSubmit={handleSubmit} className="space-y-4">
      ...
      <div id="bet-size-wrapper">
        <label htmlFor="slot-betSize" className="block text-sm font-medium text-gray-700">
          Bet Size
        </label>
        <input
          id="slot-betSize"
      ...
      <div id="rounds-wrapper">
        <label htmlFor="slot-rounds" className="block text-sm font-medium text-gray-700">
          Rounds
        </label>
        <input
          id="slot-rounds"
      ...
      <div id="small-win-chance-wrapper">
        <label
          htmlFor="slot-smallWinChance"
          className="block text-sm font-medium text-gray-700"
        >
          Small Win Chance (0–1)
        </label>
        <input
          id="slot-smallWinChance"
          type="number"
          step="0.01"
          value={smallWinChance}
      ...
      <div id="big-win-chance-wrapper">
        <label
          htmlFor="slot-bigWinChance"
          className="block text-sm font-medium text-gray-700"
        >
          Big Win Chance (0–1)
        </label>
        <input
          id="slot-bigWinChance"
          type="number"
          step="0.01"
          value={bigWinChance}
      ...
      <div id="small-win-multiplier-wrapper">
        <label
          htmlFor="slot-smallWinMultiplier"
          className="block text-sm font-medium text-gray-700"
        >
          Small Win Multiplier
        </label>
        <input
          id="slot-smallWinMultiplier"
          type="number"
          step="0.1"
          value={smallWinMultiplier}
      ...
      <div id="big-win-multiplier-wrapper">
        <label
          htmlFor="slot-bigWinMultiplier"
          className="block text-sm font-medium text-gray-700"
        >
          Big Win Multiplier
        </label>
        <input
          id="slot-bigWinMultiplier"
          type="number"
          step="0.1"
          value={bigWinMultiplier}
